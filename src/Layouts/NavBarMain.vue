<template>
    <v-app-bar app color="white" dark class="button-bar" style="height: 7.8vh;" elevation="1">
        <v-spacer></v-spacer>
        ...
        <v-img :src="nmcg"  max-width="130" max-height="55" class="image-hover"></v-img>
        <v-divider :thickness="1" color="black" vertical></v-divider>
        <v-spacer></v-spacer>
    ...
    export default {
        ...
        data() {
            return {
                ...
                abcd: require('@/assets/img/123.png'),
            }
        },
